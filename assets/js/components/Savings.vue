<template>
	<div>
		<button
			class="btn btn-link pe-0 text-decoration-none robotui-default-text text-nowrap d-flex align-items-end"
			@click="openModal"
		>
			...
			<shopicon-regular-sun class="ms-2 text-robotui"></shopicon-regular-sun>
		</button>
