<template>
	<div>
		<a
			...
			:href="githubHashUrl"
			target="_blank"
			class="btn btn-link ps-0 text-decoration-none robotui-default-text text-nowrap d-flex align-items-end"
		>
		...
		<a
			...
			target="_blank"
			class="btn btn-link robotui-default-text ps-0 text-decoration-none text-nowrap d-flex align-items-end"
		>
			<Logo class="logo me-2" />
			v{{ installed }}
		</a>
...
export default {
	...
	computed: {
		githubHashUrl: function () {
			return `https://github.com/thommyho/robotui/commit/${this.commit}`;
		},
	...
	methods: {
		...
		releaseNotesUrl: function (version) {
			return version == "0.0.0"
				? `https://github.com/thommyho/robotui/releases`
				: `https://github.com/thommyho/robotui/releases/tag/${version}`;
		},
		openModal() {
