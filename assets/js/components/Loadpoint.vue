			...
			<div>
				<div class="d-flex align-items-center">
					...
					<shopicon-regular-lightning
						class="text-robotui opacity-transiton"
...
.opacity-transiton {
	transition: opacity var(--robotui-transition-slow) ease-in;
}
.divider {
	border: none;
	border-bottom-width: 1px;
	border-bottom-style: solid;
	border-bottom-color: var(--robotui-gray);
	background: none;
	opacity: 0.5;
	margin: 0 -1rem;
}
