<template>
	<div v-if="sponsor">
		...
		>
			<button
				ref="confetti"
				class="btn btn btn-outline-primary mb-2 confetti-button bg-robotui rounded"
				@click="surprise"
			>
				<shopicon-regular-stars class="me-1 d-inline-block"></shopicon-regular-stars>
				{{ $t("footer.sponsor.confetti") }}
			</button>
			<a href="https://robotui.io/sticker" target="_blank" class="small text-muted ms-lg-3">
	...
	<div v-else>
		...
		>
			<a
				target="_blank"
				href="https://github.com/sponsors/robotui-io"
