...
.visualization--ready .site-progress-bar {
	...
	transition-duration: var(--robotui-transition-medium);
	transition-timing-function: linear;
}
.grid-import {
	background-color: var(--robotui-grid);
	color: var(--bs-white);
}
...
.self-consumption {
	background-color: var(--robotui-self);
	color: var(--bs-dark);
}
.pv-export {
	background-color: var(--robotui-export);
	color: var(--bs-dark);
}
.power {
	display: block;
...
.visualization--ready :deep(.label-bar) {
	...
	transition-duration: var(--robotui-transition-medium), var(--robotui-transition-fast);
	transition-timing-function: linear, ease;
}
.visualization--ready :deep(.label-bar-icon) {
	transition-duration: var(--robotui-transition-very-fast), 500ms;
}
</style>
