				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						>
							...
							<a
								href="https://github.com/thommyho/robotui/discussions"
								target="_blank"
						...
						>
							...
							<a
								href="https://github.com/thommyho/robotui/issues"
								target="_blank"
	...
	methods: {
		...
		async restartConfirmed() {
			try {
				...
				alert(
					"Server was stopped successfully. Waiting for the operating system to start robotui again."
				);
			} catch (e) {
