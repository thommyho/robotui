...
func (lp *Loadpoint) configureChargerType(charger api.Charger) {
	...
	// (https://github.com/thommyho/robotui/issues/2469)
...
func (lp *Loadpoint) evChargeStopHandler() {
	...
	// https://github.com/thommyho/robotui/issues/2289
	...
	if chargeCurrent != lp.chargeCurrent && chargeCurrent >= lp.GetMinCurrent() {
		...
		if err != nil {
			...
			if vv, ok := v.(api.Resurrector); ok && errors.Is(err, api.ErrAsleep) {
				// https://github.com/thommyho/robotui/issues/8254
				// wakeup vehicle
...
func (lp *Loadpoint) pvScalePhases(availablePower, minCurrent, maxCurrent float64) bool {
	...
	// - https://github.com/thommyho/robotui/issues/1572
	// - https://github.com/thommyho/robotui/issues/2230
	// - https://github.com/thommyho/robotui/issues/2613
...
func (lp *Loadpoint) UpdateChargePower() {
	err := retry.Do(func() error {
		...
		// https://github.com/thommyho/robotui/issues/2153
		// https://github.com/thommyho/robotui/issues/6986
...
func (lp *Loadpoint) publishChargeProgress() {
	if f, err := lp.chargeRater.ChargedEnergy(); err == nil {
		...
		// https://github.com/thommyho/robotui/issues/5092
...
func (lp *Loadpoint) Update(sitePower float64, autoCharge, batteryBuffered, batteryStart bool, greenShare float64, effPrice, effCo2 *float64) {
	...
	case !lp.connected():
		...
		// https://github.com/thommyho/robotui/issues/105
