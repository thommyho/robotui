...
//go:generate mockgen -package mock -destination ../mock/mock_api.go github.com/thommyho/robotui/api Charger,ChargeState,PhaseSwitcher,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff
