...
const { start, stop, restart } = require("./robotui");

const CONFIG_CONNECTED = "persist-target-minsoc-connected.robotui.yaml";
const CONFIG_DISCONNECTED = "persist-target-minsoc-disconnected.robotui.yaml";
