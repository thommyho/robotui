...
- docs: content is generated via `go generate ./...` using the above templates for the robotui documentation page to be used
...
`robotui` is a list of robotui specific system requirements
